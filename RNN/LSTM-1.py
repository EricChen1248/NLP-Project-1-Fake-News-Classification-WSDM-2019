...
def train():
	...
	#Early Stop
    callbacks = []
    callbacks.append(ModelCheckpoint('./RNN/model-LSTM1/{epoch:05d}-{val_acc:.5f}.h5', monitor='val_acc', save_best_only=False, period=1))
    model.summary()
...
MODEL_PATH = './RNN/model-LSTM1/00001-0.74481.h5'
OUTPUT_FILE_PATH = './RNN/LSTM-1.csv'
def predict():
