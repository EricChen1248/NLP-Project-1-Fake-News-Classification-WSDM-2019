...
def train():
	...
	#Early Stop
    callbacks = []
    callbacks.append(ModelCheckpoint('./RNN/model-GRU-w2v/{epoch:05d}-{val_acc:.5f}.h5', monitor='val_acc', save_best_only=False, period=1))
    model.summary()
...
MODEL_PATH = './RNN/model-GRU-w2v/00003-0.74950.h5'
OUTPUT_FILE_PATH = './RNN/GRU-w2v.csv'
def predict():
