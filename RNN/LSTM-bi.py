...
def train():
	...
	#Early Stop
    callbacks = []
    callbacks.append(ModelCheckpoint('./RNN/model-LSTMbi/{epoch:05d}-{val_acc:.5f}.h5', monitor='val_acc', save_best_only=False, period=1))
    model.summary()
...
MODEL_PATH = './RNN/model-LSTMbi/00001-0.74331.h5'
OUTPUT_FILE_PATH = './RNN/LSTMbi.csv'
def predict():
